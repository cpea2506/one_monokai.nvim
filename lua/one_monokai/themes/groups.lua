...
groups.default = {
    ...
    jsDocTags = { fg = colors.cyan, italic = config.italics },
    jsExceptions = { fg = colors.cyan },
    jsFuncArgRest = { fg = colors.purple, italic = config.italics },
    jsFuncArgs = { fg = colors.orange, italic = config.italics },
    ...
    typescriptArrowFuncArg = { fg = colors.orange, italic = config.italics },
    typescriptAsyncFuncKeyword = { fg = colors.pink },
    typescriptBinaryOp = { fg = colors.pink },
    typescriptCall = { fg = colors.orange, italic = config.italics },
    ...
    typescriptFuncType = { fg = colors.orange, italic = config.italics },
    ...
    rustParamName = { fg = colors.orange, italic = config.italics },
    ...
    cssURL = { fg = colors.orange, underline = true, italic = config.italics },
